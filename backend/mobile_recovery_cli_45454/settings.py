"""
Django settings for mobile_recovery_cli_45454 project.
...
ROOT_URLCONF = 'mobile_recovery_cli_45454.urls'
...
WSGI_APPLICATION = 'mobile_recovery_cli_45454.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mobile_recovery_cli_45454 API",
    "DESCRIPTION": "API documentation for mobile_recovery_cli_45454 App",
    "VERSION": "v1",
}
